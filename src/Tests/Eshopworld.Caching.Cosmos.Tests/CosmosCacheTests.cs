...
namespace Eshopworld.Caching.Cosmos.Tests
{
    public class CosmosCacheTests
    {
        ...
        {
            cacheFactory = new CosmosCacheFactory(new Uri("https://localhost:8081"), "C2y6yDjf5/R+ob0N8A7Cgv30VRDJIWEHLM+4QDU5DE2nQ9nDuVTqobD4b8mGGyPMbIZnqyMsEcaGQy67XIw/Jw==", "test-db");
